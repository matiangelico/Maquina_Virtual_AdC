...
public class Registros {
	...
	public int getReg(int numregistro) { //Accedo al valor del registro con su numero
        switch (numregistro){
            case 0:{return getRegistro("DS");}
            case 1:{return getRegistro("SS");}
            case 2:{return getRegistro("ES");}
            case 3:{return getRegistro("CS");}
            case 4:{return getRegistro("HP");}
            case 5:{return getRegistro("IP");}
            case 6:{return getRegistro("SP");}
            case 7:{return getRegistro("BP");}
            case 8:{return getRegistro("CC");}
            case 9:{return getRegistro("AC");}
            case 10:{return getRegistro("EAX");}
            case 11:{return getRegistro("EBX");}
            case 12:{return getRegistro("ECX");}
            case 13:{return getRegistro("EDX");}
            case 14:{return getRegistro("EEX");}
            case 15:{return getRegistro("EFX");}
            default:{return 1;}
        }
    }
	...
	public void modificaReg(int numregistro,int nuevovalor) { //actualizo el registro completo -> La ALU ve que parte modificar
		switch (numregistro){
			case 0:	{setRegistro("DS",nuevovalor);break;}
			case 1:	{setRegistro("SS",nuevovalor);break;}
			case 2:	{setRegistro("ES",nuevovalor);break;}
			case 3:	{setRegistro("CS",nuevovalor);break;}
			case 4:	{setRegistro("HP",nuevovalor);break;}
			case 5:{setRegistro("IP",nuevovalor);break;	}
			case 6:	{setRegistro("SP",nuevovalor);break;}
			case 7:	{setRegistro("BP",nuevovalor);break;}
			case 8:{setRegistro("CC",nuevovalor);break;	}
			case 9:{setRegistro("AC",nuevovalor);break;}
			case 10:{setRegistro("EAX",nuevovalor);break;}
			case 11:{setRegistro("EBX",nuevovalor);break;}
			case 12:{setRegistro("ECX",nuevovalor);break;}
			case 13:{setRegistro("EDX",nuevovalor);break;}
			case 14:{setRegistro("EEX",nuevovalor);break;}
			case 15:{setRegistro("EFX",nuevovalor);break;}
		}
	}
